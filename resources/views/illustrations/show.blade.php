...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <a href="http://localhost:8080/beap/public/illustrations" class="btn btn-light">Go back</a>
                <br/><br/>
                <div class="card">
                    ...
                    <tr>
                        @if(!Auth::guest())
                            @if(Auth::user()->id == $illustration->user_id)
                                <td>
                                    <a href="http://localhost:8080/beap/public/illustrations/{{$illustration->illustrationID}}/edit" class="btn btn-light">Modify Illustration</a>
                                </td>
                            @endif
                        @endif
                    </tr>
