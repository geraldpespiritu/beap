...
@section('content')
    ...
    <div class="card-body">
            <a href="http://localhost:85/beap/public/calamities/create" class="btn btn-danger">Add Calamity</a>
    </div>
    @if(count($calamities) > 0)
        @foreach($calamities as $calamity)
            <div class="well list-group-item">
                ...
                <div class="col-sm-3">
                    <h3><a href="http://localhost:85/beap/public/calamities/{{$calamity->calamityID}}"> {{$calamity->name}}</a></h3>
